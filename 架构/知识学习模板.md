...
- [Dynamo - Amazon’s Highly Available Key Value Store  
    Dynamo——亚马逊的极高可用性键值存储系统](./attachments/2026/09/20/170151/94284.pdf)
    
- [Google File System](./attachments/2026/09/20/170151/70314.pdf): Insights into a highly scalable file system  
    谷歌文件系统：关于一种高度可扩展文件系统的深入研究
    
- [Scaling Memcached at Facebook](./attachments/2026/09/20/170151/27277.pdf): A look at the complexities of Caching  
    在 Facebook 上实现 Memcached 的扩展：缓存机制的复杂性分析
    
- [BigTable](./attachments/2026/09/20/170151/82872.pdf): The design principles behind a distributed storage system  
...
- [Cassandra](./attachments/2026/09/20/170151/40741.pdf): A look at the design and architecture of a distributed NoSQL database  
...
- [Kafka](./attachments/2026/09/20/170151/31164.pdf): Internals of the distributed messaging platform  
    卡夫卡：分布式消息平台的内部结构
    
- [FoundationDB](./attachments/2026/09/20/170151/92888.pdf): A look at how a distributed database  
    FoundationDB：了解一下这种分布式数据库的工作原理
    
- [Amazon Aurora](./attachments/2026/09/20/170151/23287.pdf): To learn how Amazon provides high-availability and performance  
    亚马逊 Aurora：了解亚马逊如何实现高可用性和性能优化
    
- [Spanner](./attachments/2026/09/20/170151/46988.pdf): Design and architecture of Google’s globally distributed database  
...
- [Dapper](./attachments/2026/09/20/170151/46985.pdf): Insights into Google’s distributed systems tracing infrastructure  
...
- [A Comprehensive Survey on Vector Databases  
    关于矢量数据库的全面调查](./attachments/2026/09/20/170151/32377.pdf)
...
- [Thrift](./attachments/2026/09/20/170151/47518.pdf): Explore the design choices behind Facebook’s code-generation tool  
    节俭：了解 Facebook 代码生成工具背后的设计理念
    
- [Bitcoin](./attachments/2026/09/20/170151/10458.pdf): The ground-breaking introduction to the peer-to-peer electronic cash system  
...
- [MyRocks: LSM-Tree Database Storage Engine  
    我的岩石：LSM 树数据库存储引擎](./attachments/2026/09/20/170151/17152.pdf)
    
- [GoTo Considered Harmful  被视为有害的行为](https://homepages.cwi.nl/~storm/teaching/reader/Dijkstra68.pdf)
    
- [Raft Consensus Algorithm](./attachments/2026/09/20/170151/68055.pdf): To learn about the more understandable consensus algorithm  
    raft 共识算法：了解这种更易于理解的共识算法
    
- [Time Clocks and Ordering of Events](./attachments/2026/09/20/170151/22674.pdf): The extremely important paper that explains the concept of time and event ordering in a distributed system  
